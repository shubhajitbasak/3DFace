...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--eval_batch_nums', type=float, default=float('inf'), help='batch nums of images for '
                                                                                        'evaluation')
        parser.add_argument('--use_ddp', type=util.str2bool, nargs='?', const=True, default=True, help='whether use '
                                                                                                       'distributed '
                                                                                                       'data parallel')
        ...
        parser.add_argument('--add_image', type=util.str2bool, nargs='?', const=True, default=True, help='whether add '
                                                                                                         'image to '
                                                                                                         'tensorboard')
